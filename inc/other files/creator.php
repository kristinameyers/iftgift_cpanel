<h3><a href="#">Home</a> &raquo; <a href="#" class="active">The Creator Management</a></h3>
<div class="content-box">
	<div class="content-box-header">
		<h3>The Creator Management</h3>
		<div class="clear"></div>
	</div>
...
<input type="hidden" name="page" id="page" value="creator" />
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
   <tr>
    <td colspan="5">
	<?php 
		 $sql = "SELECT * from cms where page = 'creator'";
		 //echo $sql;exit;
		 ...
		 while( $row = @mysql_fetch_array($result) )
		 {
			...
			?>
			  <tr>
				...
				<td align="center">
					<div align="center"><img src="images/edit.gif" style="cursor:pointer;" title="Edit creator" onclick="document.getElementById('<?php echo $row['id'];?>').style.display='block'"  /> &nbsp;&nbsp;
				      <img src="images/dlt.gif" style="cursor:pointer;" title="Delete creator" alt="Delete creator" onclick="if(confirm('Are sure you want to delete')){window.location='process/savetext.php?action=d&page=creator&Id=<?php echo $row["id"]; ?>' }"  />				</div></td>
		      </tr>	
			  <tr>
			   <td colspan="5">
