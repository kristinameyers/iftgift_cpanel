...
if ( isset ($_POST['doSearch'] ) ) 
{
	...
	header("location:".ruadmin."home.php?p=payment_status&status=".$_GET['status']);exit;
}
...
$t.='
	...
	if($_GET['status'] == 2)
	{
	$qryString .= "and status = 1 and tap_ref_no != 'null'";
	} else if($_GET['status'] == 3) {
	$qryString .= "and status = 0 and tap_ref_no != 'null'";
	}
...
<div class="content-box">
	...
	<?php if($_GET['status'] == 2) { ?>
			<h3>Tap Orders (Checked)</h3>
	<?php } else if($_GET['status'] == 3) { ?>
			<h3>Tap Orders (New)</h3>
	<?php } ?>		
		<div class="clear"></div>
	</div>
		...
		<?php } ?>				
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				  ...
				  <tr>
                    ...
                    <td width="10%"><strong>Order No.</strong></td>
					<td width="22%"><strong>Customer Name</strong></td>
					<td width="21%"><strong>Customer Email</strong></td>
	...
	?>
							...
							<td valign="middle">
							  ...
							  <a href="<?php echo ruadmin; ?>home.php?p=check_payment&Id=<?php echo $items['Id']?>"><img src="images/read.png" title="View "   alt="View" width="28"/></a>&nbsp;&nbsp;
							   <?php } else { ?> 
							  <a href="<?php echo ruadmin; ?>home.php?p=check_payment&Id=<?php echo $items['Id']?>"><img src="images/unread.png" title="View "   alt="View"  width="28"/></a>&nbsp;&nbsp;
							   <?php } ?> 
