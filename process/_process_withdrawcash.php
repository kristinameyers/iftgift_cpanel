...
if ( isset ($_POST['editwithdraw']))
{
	...
	$sql = "UPDATE ".tbl_withdrawcash." SET wstatus='".$wstatus."' where withdrawID='".$catid."' ";
	mysql_query($sql);
	
	$OrderInfo = mysql_fetch_array(mysql_query("select userId,commission,total_price from ".tbl_withdrawcash." where withdrawID = '".$catid."'"));
    				...
    				<div style="height:764px;font-size:15px !important; line-height:0.95">
    					...
    					<div style="padding-left: 13px; padding-top: 15px;">
      						<div style="-moz-border-radius:6px;-webkit-border-radius:6px;background: #fff;margin-top: 20px;border: 1px solid #cccccc;width: 602px;padding-top: 15px;height: 632px;" >
								<p style="margin-left:10px;"><strong>Cash Amount</strong> : '.$OrderInfo['total_price'].'</p>
									<p style="margin-left:10px;"><strong>Processing Fee</strong> : '.$OrderInfo['commission'].'</p>
									<center>
